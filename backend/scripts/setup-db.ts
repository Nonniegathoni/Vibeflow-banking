...
// Override DB connection for direct credential use
process.env.DB_NAME = "vibeflow_b3jd";
process.env.DB_USER = "viber";
process.env.DB_PASSWORD = "1SnuIVB9PleqpJjQe3IrX5P4mztADQs8";
process.env.DB_HOST = "dpg-d1puu6c9c44c73924l00-a.oregon-postgres.render.com";
